...
The current supported release is [v0.1.34](https://github.com/krutftw/bitcoin09/releases/tag/v0.1.34).
It is a mandatory node update before height 12,096, where per-block ASERT
replaces the legacy 2,016-block difficulty window. Exchange wallet addresses
...
The expected version output includes `reference node v0.1.34`. Pin an exact
