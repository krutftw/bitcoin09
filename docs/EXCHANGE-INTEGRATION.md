...
The current supported release is [v0.1.20](https://github.com/krutftw/bitcoin09/releases/tag/v0.1.20).
...
The expected version output includes `reference node v0.1.20`. Pin an exact
