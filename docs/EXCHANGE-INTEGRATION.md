...
The current supported release is [v0.1.35](https://github.com/krutftw/bitcoin09/releases/tag/v0.1.35).
Exchanges must run v0.1.34 or newer for the per-block ASERT consensus rules
active since height 12,096. Exchange wallet addresses and balances are
unchanged.
...
The expected version output includes `reference node v0.1.35`. Pin an exact
