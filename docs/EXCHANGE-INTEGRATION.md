...
The current supported release is [v0.1.21](https://github.com/krutftw/bitcoin09/releases/tag/v0.1.21).
...
The expected version output includes `reference node v0.1.21`. Pin an exact
