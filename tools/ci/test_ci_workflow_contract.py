...
class CIWorkflowContractTest(unittest.TestCase):
    ...
    def test_project_contracts_cover_public_surfaces(self):
        for token in (
            ...
            "node --test tools/support/*.test.mjs",
            ...
            "tools.deploy.test_support_funding_contract",
